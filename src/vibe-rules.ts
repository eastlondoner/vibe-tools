...
**Enhanced Context Windows:** For large repositories, vibe-tools automatically enables extended context windows when available. When using \`claude-sonnet-4-20250514\` with repositories over 200k tokens, the system automatically enables Anthropic's 1M token context window feature, allowing analysis of much larger codebases without manual configuration.
